...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Ápr 14. 10:57
...
(48, 1, 1, '2025-03-28', '19:00', 'Asd', 'asd', '000000'),
(49, 1, 1, '2025-03-27', '19:00', 'Teszt Elek', 'joci.galxd@gmail.com', '06309631845');
...
CREATE TABLE `szakteruletek` (
  ...
  `szak_leiras` text NOT NULL,
  `szak_ar` varchar(255) NOT NULL,
  `szak_kep_mobil` varchar(25) NOT NULL,
  `szak_kep_web` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
INSERT INTO `szakteruletek` (`szak_id`, `szak_nev`, `szak_leiras`, `szak_ar`, `szak_kep_mobil`, `szak_kep_web`) VALUES
(1, 'Fogkő-eltávolítás és szájhigiéniai kezelés', 'A fogkő-eltávolítás és szájhigiéniai kezelés a fogak tisztítását jelenti, amely során eltávolítják a fogkövet és lepedéket ultrahangos eszközzel. A kezelés segít megőrizni a fogak és íny egészségét, megelőzve a fogszuvasodást és ínyproblémákat.', '8.000-20.000', '101.png', '301.jpeg'),
(2, 'Fogtömés és kisebb konzerváló fogászati kezelések', 'A sérült vagy szuvas fogak helyreállítása során a szuvas részeket eltávolítják, majd töméssel zárják le a fogat. Ez segít megőrizni a fog funkcióját, megelőzni a további károsodást, és biztosítja annak esztétikai megjelenését.', '10.000-50.000', '102.png', '302.jpg'),
(3, 'Rendszeres fogászati szűrővizsgálat', 'A rendszeres fogászati szűrővizsgálat során a fogorvos átvizsgálja a fogakat, az ínyt és a szájüreg egészségét, hogy időben felismerje a problémákat, mint például a szuvasodást vagy az ínygyulladást. A szűrővizsgálat segít megelőzni a komolyabb fogászati problémákat.', '10.000', '103.png', '303.jpg'),
(4, 'Gyökérkezelés (endodoncia)', 'A gyökérkezelés során a fog belső részében található fertőzött vagy gyulladt szöveteket eltávolítják, majd a fogat fertőtlenítik és betömik. A kezelés célja a fog megmentése, hogy elkerüljük a foghúzást és megőrizzük annak funkcióját.', '20.000-50.000', '104.png', '304.jpg'),
(5, 'Konzerváló fogászat és endodoncia', 'A konzerváló fogászat célja a fogak megőrzése és helyreállítása, legyen szó szuvasodás kezeléséről, fogtömésről vagy gyökérkezelésről. Az endodoncia (gyökérkezelés) során a fog belső részét fertőtlenítik és tömítik, hogy megmentsék a fogat a további károsodástól és elkerüljék a foghúzást.', '5.000-50.000', '105.png', '305.jpg'),
(6, 'Fogfehérítés', 'A fogfehérítés során különböző módszerekkel (pl. fehérítő gélek, lézeres kezelés) eltávolítják a fogak felszínén lévő elszíneződéseket, így fehérebbé és ragyogóbbá téve őket. A kezelés segít visszaállítani a fogak természetes színét és javítja a mosolyt.', '25.000', '106.png', '306.jpg'),
(11, 'Szájsebészet', 'A szájsebészet a szájüregben végzett sebészeti beavatkozásokat jelenti, mint például a foghúzás, ciszta eltávolítása, fogak beültetése, vagy íny- és állcsont műtétek. Célja a szájüreg egészségének helyreállítása és a fájdalom megszüntetése.', '35.000-250.000', '107.png', '307.jpg');
...
--
ALTER TABLE `idopont_foglalas`
  MODIFY `if_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
